                            ...
                            @foreach ($trendingCategories as $category)
                                <div class="col-md-6">
                                    <div class="banner-wrapper mrgn-b-5 mrgn-r-5 ">
                                        <img src="{{ asset('assets/uploads/category/' . $category->image) }}" alt="" height="269px">
                                        <div class="banner-wrapper3-content fw-bolder text-white">
                                            <a href="{{ route('show-category', $category->slug) }}"
                                                style="font-size: 24px !important; color: rgb(2, 153, 191); font-weight: bold;">{{ $category->name }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
